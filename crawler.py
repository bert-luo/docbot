...
def web_crawler(url, software_package, max_pages=1):
    '''
...
starting_url = "https://docs.streamlit.io/knowledge-base"  # Replace with a starting URL knowledge-base
software = "streamlit"  # Replace with the name of the software package

# Start the crawler
found_documents = web_crawler(starting_url, software)
